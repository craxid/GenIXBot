...
m.reply(res.result.replace('darling','Sensei').replace('dear','Sensei').replace('dearest','Sensei').replace('sayang','Sensei').replace('nama pengguna', 'Sensei').replace('[]', 'Sensei').replace('Anda','Sendei'))
}
