...
m.reply(res.result.replace('darling','Sensei').replace('dear','Sensei').replace('dearest','Sensei').replace('sayang','Sensei').replace('[Nama pengguna]', 'Sensei').replace('Anda','Sensei'))
}
