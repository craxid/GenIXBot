...
▢ *TOP ${len} XP* 🧬
Kamu posisi : *${usersExp.indexOf(m.sender) + 1}* dari *${usersExp.length}*
...
▢ *TOP ${len} DIAMONDS 💎* 
Kamu posisi : *${usersLim.indexOf(m.sender) + 1}* dari *${usersLim.length}*
...
▢ *TOP ${len} LEVEL* ⬆️
Kamu posisi : *${usersLevel.indexOf(m.sender) + 1}* dari *${usersLevel.length}*
