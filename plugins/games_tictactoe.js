...
export async function before(m) {
    ...
    if (room) {
        ...
        let str = `
${isWin ? `@${winner.split('@')[0]} Menang 🎉 *+${winScore} XP*` : isTie ? `Permainan selesaidengan hasil seri *+${playScore} XP*` : `Giliran kamu ${['❎', '⭕'][1 * room.game._currentTurn]} (@${room.game.currentTurn.split('@')[0]})`} 
