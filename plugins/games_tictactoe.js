...
export async function before(m) {
    ...
    if (room) {
        ...
        let str = `
${isWin ? `@${winner.split('@')[0]} Menang 🎉 *+${winScore} XP*` : isTie ? `Permainan selesai, con un empate *+${playScore} XP*` : `Ahora es tu turno ${['❎', '⭕'][1 * room.game._currentTurn]} (@${room.game.currentTurn.split('@')[0]})`} 
